...
urlpatterns = [
    ...
    path('opening-filter/', views.opening_filter_view, name='opening-filter'),
    path('opening-filter/diy/', views.opening_filter_diy_view, name='opening-filter-diy'),
    path('opening-filter/lec/', views.opening_filter_lec_view, name='opening-filter-lec'),
    path('closing-filter/', views.closing_filter_view, name='closing-filter'),
