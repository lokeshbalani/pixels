...
urlpatterns = [
    ...
    path('dilation-filter/', views.dilation_filter_view, name='dilation-filter'),
    path('dilation-filter/diy/', views.dilation_filter_diy_view, name='dilation-filter-diy'),
    path('dilation-filter/lec/', views.dilation_filter_lec_view, name='dilation-filter-lec'),
