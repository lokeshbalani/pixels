...
class AdaptiveThresholding(object):
    ...
    def generate_adaptivethresholding_image(self, blocksize):
        ...
        start = time()
        filtered_im = cv2.adaptiveThreshold(filtered_im, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY,blocksize,0)
        end = time()
