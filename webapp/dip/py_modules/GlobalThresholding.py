...
class GlobalThresholding(object):
    ...
    def generate_globalthresholding_image(self, threshold):
        ...
        #filtered_im = filtered_im[:,:,0]

        start = time()
        filtered_im = (filtered_im > threshold).astype(int)
        end = time()
